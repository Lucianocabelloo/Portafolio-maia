...
export const Footer = () => {
  return (
    <div className='w-full flex justify-around items-center text-center mt-4 bg-RosaMaia mobile:flex-col gap-4 tablet:flex-row p-3'>
        <div>
            <Image src={Logo} alt="Logo Maia Martinez" height="auto" width="auto"/>
        </div>
